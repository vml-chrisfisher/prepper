...
import { BetaSignupInterface } from './interface'

const BetaSignup = (props: BetaSignupInterface) => {
  ...
  return (
    <BetaSignupContainer>
      <ImageContainer>
        <img className="hidden-sm" src={props.heroImage.file.url} />
        <img className="hidden-lg" src={props.portraitImage.file.url} />
      </ImageContainer>
      <OverlayContainer>
        <NewsletterSignupContainer>
          <NewsletterSignupScroll stage={position}>
            <NewsletterSignupForm>
              <Title>We are solving what&apos;s for dinner.</Title>
              <Description>
                I&apos;ve believe that a homecooked meal brings people together. Creates conversations and helps bring
                us together. Though the hardest part is what to cook. We&apos;ve started a vision that brings you 7 days
                of recipes to cook. We want you to be part of that dream. Signup to be a beta tester and make this
                happen.
              </Description>
...
const FormInput = ({ ...props }) => {
  return <Field className="form--input-newsletter white-text" {...props} />
}
...
const BetaSignupContainer = styled.div`
  position: relative;
  margin-top: 73px;
  height: calc(75vw * 0.43);
  overflow: hidden;
  padding-bottom: 65px;
  @media (max-width: 767px) {
