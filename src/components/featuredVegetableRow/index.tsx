                            ...
                            <Col6Full className="col6">
                                <VegetableDetailContainer>
                                    ...
                                    <VegetableDescription>
                                        I’m baby celiac craft beer ethical godard, migas unicorn tote bag swag paleo
                                        mixtape meggings. Wayfarers forage.
                                    </VegetableDescription>
            ...
            <Col6Full className="col6">
                ...
                <div className="row">
                    ...
                    <Col6Full className="col6" style={{ paddingTop: '15%' }}>
                        ...
                        <p>
                            I’m baby celiac craft beer ethical godard, migas unicorn tote bag swag paleo mixtape
                            meggings. Wayfarers forage{' '}
                        </p>
