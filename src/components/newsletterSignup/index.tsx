        ...
        <NewsletterSignupContainer>
              <NewsletterSignupScroll stage={position}>
                  <NewsletterSignupForm>
                    ...
                    <NewsletterSignupInput onChange={event => this.setState({email: event.target.value})} placeholder="seedlings@seedlings.com" />
            <button onClick={() => this.props.onSubmit(this.state.email) } className="primaryButton">Sign up</button>
                  </NewsletterSignupForm>
